...
{
    string[] ObjectivesList = {"Find a key to get out of the room", "Find the Power Switch and activate it", "Find the wrench and use it to get access to the Power Station",
